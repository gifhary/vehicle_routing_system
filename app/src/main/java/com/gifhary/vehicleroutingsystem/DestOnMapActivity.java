...
public class DestOnMapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dest_on_map);
    ...
    //set location button for destination
    public void setLocation(View view) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (editMode){
                    //put selected destination on map to shared preferences in mode private
                    editor.putString("destinationEdit", String.valueOf(selectedLocationLat) + "," + String.valueOf(selectedLocationLong));
                    editor.apply();

                    Intent setDestinationByMap = new Intent(DestOnMapActivity.this, EditTripActivity.class);
                    startActivity(setDestinationByMap);
                    finish();

                }else {
                    //put selected destination on map to shared preferences in mode private
                    editor.putString("destLocationLat", String.valueOf(selectedLocationLat));
                    editor.putString("destLocationLong", String.valueOf(selectedLocationLong));
                    editor.apply();

                    Intent setDestinationByMap = new Intent(DestOnMapActivity.this, NewTripActivity.class);
                    startActivity(setDestinationByMap);
                    finish();
                }
            }
    ...
    public void onMapReady(GoogleMap googleMap) {
            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(this, new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        CameraUpdate yourLocation = CameraUpdateFactory.newLatLngZoom(userLoc, 10);
        ...
        //when user tap a location on map listener
    ...
    public void onBackPressed() {
        if (editMode){
            Intent cancel = new Intent(DestOnMapActivity.this, EditTripActivity.class);
            startActivity(cancel);
        }else {
            Intent cancel = new Intent(DestOnMapActivity.this, NewTripActivity.class);
            startActivity(cancel);
        }
        super.onBackPressed();
    }
